...
public class BasicDao {
	 ...
	 */
	public <T> boolean update(T t) throws RuntimeException {
     ...
     * @throws RuntimeException
	 */
	public <T> T save(T t) throws RuntimeException {
		return dao.insert(t);
	}
     ...
     * @throws RuntimeException
	 */
	public Record selectOne(String sqlStr) throws RuntimeException {
	 ...
	 * @return
	 */
	public int fetchInt(String sqlStr) {
	 ...
	 * @return
	 */
	public String dynamicTable(String tableName, long id) {
		StringBuilder sb = new StringBuilder();
		sb.append(tableName);
		sb.append(tableSuffix(id));
		return sb.toString();
	}
	 ...
	 * @return
	 */
	public long tableSuffix(long id) {
		return id % 10;
	}
}