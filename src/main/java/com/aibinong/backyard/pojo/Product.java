...
public class Product extends BaseDO{
	...
	public enum Duobao_Type {

        ONEBUY(1), TENBUY(10),HUNDREDBUY(100);
        private int v;

        private Duobao_Type(int v) {
            this.v = v;
        }
    ...
    public Integer getAuto_ai() {
        return auto_ai;
    }

    public void setAuto_ai(Integer auto_ai) {
        this.auto_ai = auto_ai;
    }
