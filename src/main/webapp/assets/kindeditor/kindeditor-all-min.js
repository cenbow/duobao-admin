		...
		j = d.createDialog({
			...
			yesBtn: {
				...
				click: function() {
					...
					b.trim(m) === "" ? (alert(f.pleaseInput+"444"), e[0].focus()) : d.insertHtml(h).hideDialog().focus()
				}
			}
		}),
		e = b("textarea", j.div);
...
function(b) {
	...
	var f = this,
	j = b.undef(f.fileManagerJson, f.basePath + "uploadFile.html"),
...
function(b) {
	...
	o = b.undef(d.uploadJson, d.basePath + "/uploadFile.html");
	d.plugin.flash = {
		edit: function() {
			...
			s = d.createDialog({
				...
				yesBtn: {
					...
					click: function() {
						...
						f = r.val(),
						h = z.val();
						e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")+"5"), p[0].focus()) : /^\d*$/.test(f) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
							src: e,
							type: b.mediaType(".swf"),
							width: f,
							height: h,
							quality: "high"
						}), d.insertHtml(e).hideDialog().focus()) : (alert(d.lang("invalidHeight")+"66"), z[0].focus()) : (alert(d.lang("invalidWidth")), r[0].focus())
					}
				}
			}),
			v = s.div,
...
function(b) {
	...
	m = b.undef(d.uploadJson, d.basePath + "/uploadFile.html"),
...
function(b) {
	...
	e = b.undef(d.formatUploadUrl, !0),
	h = b.undef(d.uploadJson, d.basePath + "/uploadFile.html"),
	m = b.undef(d.extraFileUploadParams, {}),
	n = b.undef(d.filePostName, "imgFile"),
	o = d.lang("insertfile.");
...
function(b) {
	...
	var f = b.undef(d.uploadJson, d.basePath + "/uploadFile.html"),
