...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			(options.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="/uploadFile.html">'),
...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		fileManagerJson = K.undef(self.fileManagerJson, self.basePath + 'uploadFile.html'),
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + '/uploadFile.html');
	self.plugin.flash = {
		edit : function() {
			var html = [
