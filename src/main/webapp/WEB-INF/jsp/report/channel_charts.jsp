        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default bk-bg-white">
                ...
                <div class="panel-body">
                    <form id="editForm" action="reportChannelCharts.html" method="post">
                 ...
                 <div class="row">					
					<div class="col-lg-12">
						<div class="panel panel-default bk-bg-white">
							...
							<div class="panel-body">
								<div id="channelAmountEcharts" style="height:300px" ></div>
								<script type="text/javascript">
								    ...
								    require(
								        ...
								        function(ec) {
								            ...
								            var myChart = ec.init(document.getElementById('channelAmountEcharts')); 
								            var option = ${channelAmountEcharts};
								            // 为echarts对象加载数据 
				...
				<div class="row">					
					<div class="col-lg-12">
						<div class="panel panel-default bk-bg-white">
							...
							<div class="panel-body">
								<div id="channelPayerEcharts" style="height:300px" ></div>
								<script type="text/javascript">
								     // 路径配置
								    require.config({
								        paths:{ 
								    ...
								    require(
								        ...
								        function(ec) {
								            // 基于准备好的dom，初始化echarts图表
								            var myChart = ec.init(document.getElementById('channelPayerEcharts')); 
								            var option = ${channelPayerEcharts};
								            // 为echarts对象加载数据 
								            myChart.setOption(option); 
								        }
								    );
					...
					<div class="col-lg-12">
						<div class="panel panel-default bk-bg-white">
							...
							<div class="panel-body">
								<div id="channelConversionEcharts" style="height:300px" ></div>
								<script type="text/javascript">
								     // 路径配置
								    require.config({
								        paths:{ 
								    ...
								    require(
								        ...
								        function(ec) {
								            // 基于准备好的dom，初始化echarts图表
								            var myChart = ec.init(document.getElementById('channelConversionEcharts')); 
								            var option = ${channelConversionEcharts};
								            // 为echarts对象加载数据 
								            myChart.setOption(option); 
								        }
								    );
											...
											<c:otherwise>
												<c:forEach items="${list}" var="item">
													<tr class="gradeX">
						                                ...
						                                <td align="right">${item.new_pay_amounts_fmt}</td>
