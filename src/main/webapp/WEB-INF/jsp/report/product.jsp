        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default bk-bg-white">
                <div class="panel-heading bk-bg-white">
                    <h6><i class="fa fa-hand-o-right"></i><span class="break"></span>商品报表</h6>
                ...
                <div class="panel-body">
                    <form id="editForm" action="reportProduct.html" method="post">
                        ...
                        <div class="row datatables-header form-inline">
                            <div class="col-sm-12 col-md-12">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            商品ID:<input type="text" class="form-control" name="productId" value="${productId}"/>
                                        </td>
                                        <td>
						                        ...
						                        <c:choose>
													...
													<c:otherwise>
														<c:forEach items="${list}" var="item">
															<tr class="gradeX">
								                            	<td>${item.date}</td>
								                                <td><a href="reportProductCharts.html?productId=${item.product_id}">${item.product_id}</a></td>
								                                <td><img src="${item.list_img}" style="height:50px;"></td>
								                                <td>${item.title}</td>
								                                <td align="right">${item.numbers}</td>
								                                <td align="right">${item.amount_fmt}</td>
								                            </tr>
														</c:forEach>
													</c:otherwise>
												</c:choose>
