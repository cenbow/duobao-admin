								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form   class="form-horizontal form-bordered " id="editForm" method="post" >
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">redisKey值</label>
                                            
                                            <div class="col-md-3">
                                               <input type="text" id="key" name="key" class="form-control" value='' required/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
											<div class="col-sm-12">
												<div align="center">
													<a href="javascript:void(0)"id="addToTable" class="btn btn-info" onclick="redisDel()">保存 <i class="fa fa-save"></i></a>
												</div>
											</div>
										</div>
									</form>
...
<script src="assets/vendor/js/jquery.min.js"></script>
		...
		<script type="text/javascript">
			 function redisDel(){
		 	   ...
		 	   if(a==true){
		 		   $.get("/redisDel.html?key="+key,function(data){
