						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>创建后台用户</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="insertAccount.html"  class="form-horizontal form-bordered " id="editForm" method="post">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">用户账号</label>
                                            <div class="col-md-3">
                                               <input type="text" id="account_name" name="account_name" class="form-control" value='' required/>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">账号密码</label>
                                            <div class="col-md-3">
                                               <input type="text" id="account_pwd" name="account_pwd" class="form-control" value='' required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">用户角色</label>
                                            <div class="col-md-6">
                                              <c:forEach var="role" items="${rolelist}" varStatus='s'>
												 <div class="checkbox-custom checkbox-inline">
													<input type="checkbox" id="inline-checkboxs${s.index}" name="roleId" value="<c:out value="${role.id}"/>"> 
													<label for="inline-checkbox${s.index}"> <c:out value="${role.role_name}"/></label>
												</div>
                                                </c:forEach>
                                            </div>
                                        </div>
