						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>用户详情</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="accountEdit.html"  class="form-horizontal form-bordered " id="editForm" method="post">
									<input type="hidden" id="accountId" name="accountId" class="form-control" value='<c:out value="${useraccount.id}"/>'/>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">用户名称</label>
                                            <div class="col-md-3">
                                               <input type="text" id="account" name="account" class="form-control" value='<c:out value="${useraccount.account}"/>'/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                              <c:forEach var="role" items="${rolelist}" varStatus='s'>
												 <div class="checkbox-custom checkbox-inline">
													<input type="checkbox" id="inline-checkboxs${s.index}" name="roleId" value="<c:out value="${role.id}"/>" <c:if test="${accountMapp[role.id]!=null}">checked</c:if>> 
