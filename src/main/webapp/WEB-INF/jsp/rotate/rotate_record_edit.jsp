					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default bk-bg-white">
							<div class="panel-heading bk-bg-white">
								<h6>
									<i class="fa fa-hand-o-right"></i><span class="break"></span>编辑中奖纪录
								</h6>
							...
							<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
								<!-- 表单 -->
								<form action="saveRotateRecordEdit.html" class="form-horizontal form-bordered" id="form" method="post">
									<input type="hidden" id="id" name="id" value="${record.id}"/>
									<input type="hidden" id="rotate_id" name="rotate_id" value="${record.rotateId}"/>
									<div class="form-group">
										...
										<div class="col-md-3">
											<select id="type" class="form-control" style="width:100px;" id="status" name="status">
												<option value="0" <c:if test="${record.status == 0}">selected</c:if>>未兑换</option>
												<option value="1" <c:if test="${record.status == 1}">selected</c:if>>已兑换</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="remark">备注<span class="required">*</span></label>
										<div class="col-md-6">
											<textarea id="remark" name="remark" class="form-control" rows="5" cols="20">${record.remark}</textarea>
										</div>
									</div>
									<!-- 保存按钮 -->
									<div class="row">
