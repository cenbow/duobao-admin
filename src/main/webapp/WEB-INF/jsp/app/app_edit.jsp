					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default bk-bg-white">
							<div class="panel-heading bk-bg-white">
								<h6>
									<i class="fa fa-hand-o-right"></i><span class="break"></span>编辑包
								</h6>
							...
							<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
								<!-- 表单 -->
								<form action="updateApp.html" class="form-horizontal form-bordered" id="form" method="post" enctype="multipart/form-data">
									<!-- 包ID -->
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" id="name" name="name" class="form-control" value="${app.name}" required/>
										</div>
									</div>
									<!-- 副标题 -->
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" id="sub_title" name="sub_title" class="form-control" value="${app.sub_title}" />
										</div>
									</div>
									<!-- 描述 -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea id="description" name="description" class="form-control" rows="5" cols="20">${app.description}</textarea>
										</div>
									</div>
									<!-- 关键字 -->
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea id="keyword" name="keyword" class="form-control" rows="5" cols="20">${app.keyword}</textarea>
										</div>
									</div>
									<!-- ICON -->
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="hidden" id="icon" name="icon" value="${app.icon}" />
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="hidden" id="material_url" name="material_url" value="${app.material_url}" />
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<select id="watermark" name="watermark" class="form-control">
												...
												<option value="@!yiyuanduobao" <c:if test="${app.watermark == '@!yiyuanduobao'}">selected</c:if>>@!yiyuanduobao</option>
												<option value="@!yiyuanyungou" <c:if test="${app.watermark == '@!yiyuanyungou'}">selected</c:if>>@!yiyuanyungou</option>
											</select>
										</div>
									</div>
									<!-- 更多信息 -->
									...
									<div id="extend" style="display:none">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_d_appid" name="getui_d_appid" class="form-control" value="${app.getui_d_appid}" />
											</div>
										</div>
										<!-- 个推（Debug）AppKey -->
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_d_appkey" name="getui_d_appkey" class="form-control" value="${app.getui_d_appkey}" />
											</div>
										</div>
										<!-- 个推（Debug）AppMaster -->
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_d_appmaster" name="getui_d_appmaster" class="form-control" value="${app.getui_d_appmaster}" />
											</div>
										</div>
										<!-- 个推（Debug）AppSecret -->
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_d_appsecret" name="getui_d_appsecret" class="form-control" value="${app.getui_d_appsecret}"/>
											</div>
										</div>
										<!-- 个推（Release）AppID -->
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_r_appid" name="getui_r_appid" class="form-control" value="${app.getui_r_appid}" />
											</div>
										</div>
										<!-- 个推（Release）AppKey -->
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_r_appkey" name="getui_r_appkey" class="form-control" value="${app.getui_r_appkey}" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_r_appmaster" name="getui_r_appmaster" class="form-control" value="${app.getui_r_appmaster}" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" id="getui_r_appsecret" name="getui_r_appsecret" class="form-control" value="${app.getui_r_appsecret}"/>
											</div>
										</div>
										<!-- iOS扩展字段 -->
										<div id="ios_extend_content">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="ios_account" name="ios_account" class="form-control" value="${app.ios_account}" />
												</div>
											</div>
											<!-- iOS AppID -->
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="ios_appid" name="ios_appid" class="form-control" value="${app.ios_appid}" />
												</div>
											</div>
											<!-- iOS BundleID -->
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="ios_bundleid" name="ios_bundleid" class="form-control" value="${app.ios_bundleid}" />
												</div>
											</div>
											<!-- iOS 友盟ID -->
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="ios_umeng_appid" name="ios_umeng_appid" class="form-control" value="${app.ios_umeng_appid}" />
												</div>
											</div>
										</div>
										<!-- Android扩展字段 -->
										<div id="android_extend_content">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="android_package" name="android_package" class="form-control" value="${app.android_package}" />
												</div>
											</div>
											<!-- 安卓友盟ID -->
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="android_umeng_appid" name="android_umeng_appid" class="form-control" value="${app.android_umeng_appid}" />
												</div>
											</div>
										</div>
									</div>
