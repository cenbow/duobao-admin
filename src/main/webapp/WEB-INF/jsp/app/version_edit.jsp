					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-default bk-bg-white">
							<div class="panel-heading bk-bg-white">
								<h6>
									<i class="fa fa-hand-o-right"></i><span class="break"></span>版本编辑
								</h6>
							...
							<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
								...
								<form action="updateAppVersion.html" class="form-horizontal form-bordered" id="form" method="post" enctype="multipart/form-data">
									<input type="hidden" id="id" name="id" value="${download.id}" readonly/>
									<input type="hidden" id="os" name="os" value="${download.app.os}" readonly/>
									<input type="hidden" id="channel" name="channel" value="${download.channel}" readonly/>
									<!-- 包ID -->
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" id="show_channel" name="show_channel" class="form-control" value="${channel}" readonly/>
										</div>
									</div>
									<!-- 版本代码 -->
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" id="version" name="version" class="form-control" value="${download.version}"/>
										</div>
									</div>
									<!-- 下载地址 -->
									...
									<div id="reason_content" class="form-group">
										...
										<div class="col-sm-6">
											<textarea id="reason" name="reason" class="form-control" rows="5" cols="20">${download.reason}</textarea>
										</div>
									</div>
									<!-- 操作按钮 -->
									<div class="row">
