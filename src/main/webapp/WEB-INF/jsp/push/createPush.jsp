						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>添加推送</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="insertPush.html"  class="form-horizontal form-bordered " id="editForm" method="post">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">客户端</label>
                                            <div class="col-md-6">
													  <c:forEach var="app" items="${applist}">
                                              		  	<input type="checkbox" id="dest" name="dest" value="<c:out value="${app.client_id}"/>"> 
														<label for="inline-radio1"> <c:out value="${app.name}"/>--<c:out value="${app.client_id}"/></label>
                                              		  </c:forEach>
                                         </div>
                                         </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                             <input type="text" class="form-control" name="send_time" id="send_time"  placeholder="发送时间"  value='' required>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">事件</label>
                                            <div class="col-md-3">
                                             <input type="number" id="event_type" name="event_type" class="form-control" value='' required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
