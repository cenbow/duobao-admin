						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>商品详情</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="productEdit.html"  class="form-horizontal form-bordered " id="editForm" method="post"enctype="multipart/form-data" >
									<input type="hidden" id="id" name="id" value="<c:out value="${product.id}"/>">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">商品名称</label>
                                            <div class="col-md-3">
                                               <input type="text" id="title" name="title" class="form-control" value='<c:out value="${product.title}"/>'/>
                                            </div>
                                        </div>
                                        <div class="form-group">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" for="select">SPU</label>
											<div class="col-md-3">
												<select id="spu_id" name="spu_id" class="form-control input-lg" size="1">
												     <c:forEach var="spu" items="${spulist}">
                                              		  	<option value="<c:out value="${spu.id}"/>"   <c:if test="${product.spu_id==spu.id}">selected</c:if> > <c:out value="${spu.title}"/> </option>
                                              		 </c:forEach>
												</select>
											</div>
										</div>	
										<div class="form-group">
											...
											<div class="col-md-4">
												 ...
												 <div class="checkbox-custom checkbox-inline">
													<input type="checkbox" id="inline-checkboxs${s.index}" name="cate_id" value="<c:out value="${cate.id}"/>" <c:if test="${procatelist[cate.id]!=null}">checked</c:if>> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="file" id="list_img" name="list_img" class="form-control" value=''/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">轮播图</label>
                                            <div class="col-md-3">
                                               <input type="file" name="loop_img1" class="form-control" value='' />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="text" id="sub_title" name="sub_title" class="form-control" value='<c:out value="${product.sub_title}"></c:out>'/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">真实价格(单位:元)</label>
                                            <div class="col-md-3">
                                               <input type="number" id="real_cost" name="real_cost" class="form-control" value='<c:out value="${product.real_cost}"></c:out>' onkeyup="this.value=this.value.replace(/\D/g,'')"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">库存</label>
                                            <div class="col-md-3">
                                               <input type="number" id="numbers" name="numbers" class="form-control" value='<c:out value="${product.numbers}"></c:out>' onkeyup="this.value=this.value.replace(/\D/g,'')"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">夺宝总份数</label>
                                            <div class="col-md-3">
                                               <input type="number" id="total_count" name="total_count" class="form-control" value='<c:out value="${product.total_count}"></c:out>' onkeyup="this.value=this.value.replace(/\D/g,'')"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">默认购买份数</label>
                                            <div class="col-md-3">
                                               <input type="number" id="default_count" name="default_count" class="form-control" value='<c:out value="${product.default_count}"></c:out>' required/>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <select id="duobao_type" name="duobao_type" class="form-control input-lg" size="1" required>
													<option value="1" <c:if test="${product.duobao_type==1}">selected</c:if>>1元夺宝</option>
													<option value="10" <c:if test="${product.duobao_type==10}">selected</c:if>>10元夺宝</option>
													<option value="100" <c:if test="${product.duobao_type==100}">selected</c:if>>100元夺宝</option>
												</select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                              		<input type="checkbox" id="is_new" name="is_new" value="1" par="tag" <c:if test="${product.is_new==1}">checked</c:if> > 
													<label for="is_new">新</label>
													<input type="checkbox" id="is" name="is_hot" value="1"  par="tag" <c:if test="${product.is_hot==1}">checked</c:if>> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="number" id="weight" name="weight" class="form-control" value='<c:out value="${product.weight}"/>' required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">详情页面</label>
														<div class="form-group">									
															<div class="col-md-7">
															<textarea name="content" style="width:600px;height:400px;visibility:hidden;" value=''><c:out value="${product.content}"></c:out></textarea>
															</div>
														</div>
										</div>
                                        ...
                                        <div class="row">
											<div class="col-sm-12">
												<div align="center">
													<button id="addToTable" class="btn btn-info" onclick="doSubmit();">保存 <i class="fa fa-save"></i></button>
