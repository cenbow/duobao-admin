	...
	<div class="row">
		...
		<div class="body-sign body-locked">
			<div class="center-sign">
				<div align="center">
					<div class="panel panel-default bk-bg-white" style="width:350px;">
						<div class="panel-heading bk-bg-white">
							<h6><i class="fa fa-info-circle"></i>错误提示</h6>
						...
						<div class="panel-body alerts">
							...
							<div align="center">
								<a href="javascript: history.go(-1)">
									<button class="bk-margin-5 btn btn-danger center">返&nbsp;回&nbsp;<i class="fa fa-reply"></i></button>
								</a>
							</div>
						</div>
					</div>
