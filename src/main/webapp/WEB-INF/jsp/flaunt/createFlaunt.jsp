						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>添加晒单</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="shareLuckShow.html"  class="form-horizontal form-bordered " id="editForm" method="post"enctype="multipart/form-data" >
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">期次</label>
                                            <div class="col-md-3">
                                               <input type="text" id="periodId" name="periodId" class="form-control" value='<c:out value="${period.id}"/>' readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">商品名称</label>
                                            <div class="col-md-3">
                                               <input type="text" id="prodcut_title" name="prodcut_title" class="form-control" value='<c:out value="${period.title}"/>' readonly/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">上传晒单图</label>
                                            <div class="col-md-3">
                                               <input type="file" name="img1" class="form-control" value='' required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="text" id="sub_title" name="title"class="form-control" value='' required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">晒单时间</label>
                                            <div class="col-md-3">
                                            <input type="text" class="form-control" name="shareTime" id="shareTime"  placeholder="晒单时间"  value=''>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
												<div class="radio-custom radio-inline">
													<input type="radio" id="good1" name="good" value="1" required> 
													<label for="inline-radio1"> 是</label>
												</div>
												<div class="radio-custom radio-inline">
													<input type="radio" id="good2" name="good" value="0" checked> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
												<div class="radio-custom radio-inline">
													<input type="radio" id="recommend1" name="recommend" value="1" required> 
													<label for="recommend1"> 是</label>
												</div>
												<div class="radio-custom radio-inline">
													<input type="radio" id="recommend2" name="recommend" value="0" checked> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                            <div class="radio-custom radio-inline">
													<input type="radio" id="audit_status1" name="audit_status" value="1" required> 
													<label for="audit_status1"> 是</label>
												</div>
												<div class="radio-custom radio-inline">
													<input type="radio" id="audit_status2" name="audit_status" value="0" checked> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="number" id="weight" name="weight" class="form-control" value='' required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
											<label class="col-md-3 control-label" for="textarea-input">内容</label>
											<div class="col-md-7">
												<textarea id="textarea-input" name="content" rows="7" class="form-control" placeholder="Content.." required></textarea>
											</div>
										</div>
                                        <div class="row">
											<div class="col-sm-12">
...
<script src="assets/kindeditor/lang/zh_CN.js"></script> 
        <script type="text/javascript">
            ...
            function flauntListPage(){
            	location="/notLuckShowPeriodlist.html";
            }
        </script>
		<!-- end: JavaScript-->
