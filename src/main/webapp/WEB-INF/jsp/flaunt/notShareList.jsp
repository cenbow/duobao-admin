                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-default bk-bg-white">
                        <div class="panel-heading bk-bg-white">
                            <h6><i class="fa fa-hand-o-right"></i><span class="break"></span>未晒单期次列表</h6>
                        ...
                        <div class="panel-body">
                         <form action="notLuckShowPeriodlist.html" id="editForm" method="post">
                            ...
                            <table class="table table-bordered table-striped" id="datatable-default">
                                ...
                                <c:forEach var="period" items="${periodlist}">
                                    <tr class="gradeX">
                                        ...
                                        <td style="vertical-align: middle;">
                                        	<a href='createLuckShow.html?periodId=<c:out value="${period.id}"/>' class="btn btn-success"><i class="fa fa-search-plus">晒单</i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
