						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-hand-o-right"></i><span class="break"></span>添加站内信</h6>							
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form action="createLetter.html"  class="form-horizontal form-bordered " id="editForm" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                             <input type="text" class="form-control" name="send_time" id="send_time"  placeholder="发送时间"  value=''>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label" for="remark">发送目标</label>
                                            <div class="col-md-3">
                                             <input type="text" id="userId" name="userId" class="form-control" placeholder="默认所有用户"  value=''/>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                             <input type="text" id="event_type" name="event_type" class="form-control" value=''/>
                                            </div>
                                        </div>
                                        <div class="form-group">
